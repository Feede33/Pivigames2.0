    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          // No solicitar información adicional del perfil
          queryParams: {
      ...
      <DialogContent className="bg-gray-900 border-gray-700 text-gray-200 max-w-sm">
        ...
        <div className="space-y-3 py-4">
          ...
          <Button
            ...
            className="w-full h-12 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold text-base transition-all"
          >
            {isLoading === 'discord' ? (
          ...
          <Button
            ...
            disabled={isLoading !== null}
            className="w-full h-12 bg-white hover:bg-gray-100 text-gray-900 font-semibold text-base transition-all"
          >
            {isLoading === 'google' ? (
              <div className="flex items-center gap-2">
