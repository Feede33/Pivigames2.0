  ...
  const styles = {
    xs: {
      ...
      viewer: {
        ...
        thumbnails: { bottom: '0.5rem', gap: '0.25rem', overflow: 'hidden', },
    ...
    sm: {
      ...
      viewer: {
        ...
        thumbnails: { bottom: '0.75rem', gap: '0.375rem', overflow: 'hidden', },
    ...
    md: {
      ...
      viewer: {
        ...
        thumbnails: { bottom: '1rem', gap: '0.5rem', overflow: 'hidden', },
