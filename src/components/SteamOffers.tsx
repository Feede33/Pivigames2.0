...
export default function SteamOffers({ specials, loading, t, onSpecialClickAction }: Props) {
  ...
  return (
    <section className="relative group animate-pulse-fade-in animate-delay--1000 animate-duration-1000 animation-modern">
      <div className="flex items-center justify-between mb-4 md:mb-6 lg:mb-8">
        <div>
          ...
          <p className="text-muted-foreground text-xs md:text-sm">{t.offers.subtitle}</p>
        </div>
      </div>

      <div
        id="offers-scroll"
        className="flex gap-3 md:gap-4 lg:gap-6 overflow-x-auto pb-4 md:pb-6 pt-2 scrollbar-hide scroll-smooth pl-2 md:pl-3"
      >
        {specials.map((special) => (
          ...
          >
            <div className="relative rounded-lg md:rounded-xl overflow-hidden mb-3 md:mb-4 shadow-2xl hover:shadow-green-500/20 transition-all duration-500 hover:scale-[1.02] border border-white/5">
              {/* Imagen principal */}
              <div className="w-full aspect-[460/215] bg-gradient-to-br from-purple-900 via-blue-900 to-black relative overflow-hidden">
                <img
              ...
              <div className="absolute top-2 md:top-4 left-2 md:left-4 z-20">
                <div className="relative bg-gradient-to-br from-green-600 via-green-500 to-emerald-600 px-2 md:px-3 py-1.5 md:py-2 rounded-md shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-300">
                  <div className="absolute inset-0 bg-gradient-to-tr from-white/20 to-transparent rounded-md"></div>
                  <div className="relative flex flex-col items-center">
                    <span className="text-[8px] md:text-[10px] font-bold text-green-100 uppercase tracking-wider leading-none">
                      {t.offers.save}
                    </span>
                    <span className="text-lg md:text-2xl font-black text-white leading-none mt-0.5">
              ...
              <div className="absolute top-2 md:top-4 right-2 md:right-4">
                {special.hasDownloadLink ? (
                  <div className="relative">
                    ...
                    <span className="relative bg-gradient-to-r from-blue-500 to-cyan-600 text-white text-[10px] md:text-xs font-bold px-2 md:px-3 py-1 md:py-1.5 rounded-lg shadow-lg flex items-center gap-1 md:gap-1.5 backdrop-blur-sm">
                      ...
                      <span className="hidden sm:inline">{t.offers.available}</span>
                  ...
                  <div className="relative">
                    ...
                    <span className="relative bg-gradient-to-r from-orange-500/90 to-amber-600/90 text-white text-[10px] md:text-xs font-bold px-2 md:px-3 py-1 md:py-1.5 rounded-lg shadow-lg flex items-center gap-1 md:gap-1.5 backdrop-blur-sm border border-orange-400/30">
              ...
              <div className="absolute bottom-2 md:bottom-4 right-2 md:right-4 flex gap-1.5 md:gap-2">
                {special.platforms.windows && (
                  <span className="bg-black/80 backdrop-blur-md text-white text-[10px] md:text-xs font-medium px-1.5 md:px-2.5 py-1 md:py-1.5 rounded-md border border-white/10 shadow-lg">
                    <svg className="w-2.5 h-2.5 md:w-3 md:h-3 inline mr-0.5 md:mr-1" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="space-y-1.5 md:space-y-2 px-1">
              <h4 className="font-bold text-sm md:text-base line-clamp-2 group-hover/card:text-green-400 transition-colors duration-300">
                {special.name}
              </h4>
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <span className="text-base md:text-lg font-black bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">
                    {formatPrice(special.final_price, special.currency)}
                  </span>
                </div>
                <div className="text-[10px] md:text-xs text-muted-foreground bg-muted/20 px-1.5 md:px-2 py-0.5 md:py-1 rounded">
                  {t.offers.save}{' '}
      ...
      <button
        ...
        className="hidden lg:block absolute left-4 top-1/2 -translate-y-1/2 z-20 group/btn opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110"
      >
      ...
      <button
        ...
        className="hidden lg:block absolute right-4 top-1/2 -translate-y-1/2 z-20 group/btn opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110"
      >
