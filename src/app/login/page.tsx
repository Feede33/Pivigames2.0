    ...
    >
      ...
      <Card className="w-full max-w-sm relative z-10 border-[#212121]/30 bg-[#171717] backdrop-blur-lg">
        ...
        <CardFooter className="flex-col gap-3">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[#5865F2]/70 via-[#5865F2]/60 to-[#5865F2]/70 group-hover:from-[#5865F2]/80 group-hover:via-[#5865F2]/70 group-hover:to-[#5865F2]/80 transition-all duration-300" />
            <svg className="w-5 h-5 mr-2 relative z-10 drop-shadow-lg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="relative z-10 font-semibold drop-shadow-lg">Continuar con Discord</span>
          </Button>
