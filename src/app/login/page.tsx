      ...
      <Card className="w-full max-w-sm relative z-10 border-[#212121]/30 bg-[#171717] backdrop-blur-lg">
        ...
        <CardFooter className="flex-col gap-3">
          ...
          <Button
            ...
            style={{
              backgroundImage: 'url(/[locale]/discordwallpaper/bannerdiscord.jpg)',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
            <div className="absolute inset-0 bg-[#5865F2]/40 backdrop-blur-[2px]" />
            ...
            <span className="relative z-10">Continuar con Discord</span>
          </Button>
